/* hash.c - SHA-256 pour détecter les changements de contenu
 *
 * Implémentation SHA-256 pure C, sans dépendance externe.
 * Source : algorithme public domain.
 */
